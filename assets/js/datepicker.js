gapi.analytics.ready(function() {
    ...
    gapi.analytics.createComponent('Datepicker', {
         ...
         */
        template: '<div class="Datepicker">' + '  <div class="Datepicker-item">' + '    <label>Start Date</label> ' + '    <input type="date">' + '  </div>' + '  <div class="Datepicker-item">' + '    <label>End Date</label> ' + '    <input type="date">' + '  </div>' + '</div>'
    });
