gapi.analytics.ready(function() {
    ...
    gapi.analytics.createComponent('Viewpicker', {
         ...
         */
        template: '<div class="Viewpicker">' + '  <div class="Viewpicker-item">' + '    <label>Account</label>' + '    <select></select>' + '  </div>' + '  <div class="Viewpicker-item">' + '    <label>Property</label>' + '    <select></select>' + '  </div>' + '  <div class="Viewpicker-item">' + '    <label>View</label>' + '    <select></select>' + '  </div>' + '</div>'
    });
    ...
    function updateSelectOptions(select, options) {
        select.innerHTML = options.map(function(option, i) {
            return '<option value="' + (option.value || i) + '">' + option.name + '</option>';
        }).join('');
    }
    ...
    var accountSummaries = (function() {
        ...
        return {
            ...
            get: function() {
                ...
                requestAccountSummaries().then(trimAccountSummaries).
                catch (function(err) {
                    console.error(err.stack);
                }));
            }
