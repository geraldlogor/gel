...
(function(undefined) {
    ...
    var moment, VERSION = "2.7.0",
        ...
        relativeTimeThresholds = {
            ...
            //hours to days
            dd: 25,
            //days to month (month == 1)
            dm: 45,
            //days to months (months > 1)
            dy: 345 //days to year
        },
    ...
    function makeList(field) {
        ...
        moment[field] = function(format, index) {
            var i, getter, method = moment.fn._lang[field],
                results = [];
    ...
    function checkOverflow(m) {
        ...
        if (m._a && m._pf.overflow === -2) {
            overflow =
            m._a[MONTH] < 0 || m._a[MONTH] > 11 ? MONTH : m._a[DATE] < 1 || m._a[DATE] > daysInMonth(m._a[YEAR], m._a[MONTH]) ? DATE : m._a[HOUR] < 0 || m._a[HOUR] > 23 ? HOUR : m._a[MINUTE] < 0 || m._a[MINUTE] > 59 ? MINUTE : m._a[SECOND] < 0 || m._a[SECOND] > 59 ? SECOND : m._a[MILLISECOND] < 0 || m._a[MILLISECOND] > 999 ? MILLISECOND : -1;
    ...
    function getLangDefinition(key) {
        var i = 0,
            j, lang, next, split, get = function(k) {
    ...
    function addTimeToArrayFromToken(token, input, config) {
        ...
        case 'e':
        case 'E':
            token = token.substr(0, 1); /* falls through */
        case 'gggg':
        case 'GGGG':
        case 'GGGGG':
    ...
    function dateFromObject(config) {
        ...
        config._a = [
        normalizedInput.year, normalizedInput.month, normalizedInput.day, normalizedInput.hour, normalizedInput.minute, normalizedInput.second, normalizedInput.millisecond];
    ...
    function makeGlobal(shouldDeprecate) { /*global ender:false */
