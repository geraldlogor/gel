    ...
    var each = helpers.each = function(loopable, callback, self) {
        ...
        template = helpers.template = function(templateString, valuesObject) {
            ...
            function tmpl(str, data) {
		        ...
		        //----NOTE----Modified based on https://github.com/nnnick/Chart.js/issues/68#issuecomment-20918194
		        var result = data ? fn(data) : fn;
		        result = result.replace(result.match(/\d+/g), thousand_separator(String(result.match(/\d+/g))));
		        return result;
            }
    ...
    extend(Chart.Type.prototype, {
        ...
        render: function(reflow) {
            ...
            if (this.options.animation && !reflow) {
                ...
                this.draw, this.options.animationSteps, this.options.animationEasing, this.options.onAnimationProgress, this.options.onAnimationComplete, this);
            } else {
                this.draw();
                    ...
                    if (index > 0) {
                        ...
                        if (this.showLabels) {
                            ...
                            if (this.showLabelBackdrop) {
                                ...
                                ctx.fillRect(
                                this.xCenter - labelWidth / 2 - this.backdropPaddingX, yHeight - this.fontSize / 2 - this.backdropPaddingY, labelWidth + this.backdropPaddingX * 2, this.fontSize + this.backdropPaddingY * 2);
                            }
                            ctx.textAlign = 'center';
                            ctx.textBaseline = "middle";
        ...
        buildScale: function(labels) {
            ...
            var scaleOptions = {
                ...
                calculateYRange: function(currentHeight) {
                    ...
                    dataTotal(), currentHeight, this.fontSize, this.beginAtZero, this.integersOnly);
            ...
            helpers.each(this.datasets, function(dataset) {
                ...
                helpers.each(dataset.points, function(point, index) {
                    if (index > 0) {
                        if (this.options.bezierCurve) {
                            ctx.bezierCurveTo(
                            dataset.points[index - 1].controlPoints.outer.x, dataset.points[index - 1].controlPoints.outer.y, point.controlPoints.inner.x, point.controlPoints.inner.y, point.x, point.y);
                        } else {
...
(function() {
    ...
    Chart.Type.extend({
        ...
        updateScaleRange: function(datapoints) {
            ...
            valuesArray, helpers.min([this.chart.width, this.chart.height]) / 2, this.options.scaleFontSize, this.options.scaleBeginAtZero, this.options.scaleIntegersOnly);

            helpers.extend(
            this.scale, scaleSizes, {
