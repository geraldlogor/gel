...
(function UMD(name, context, definition) {
...
})("Promise", typeof global !== "undefined" ? global : this, function DEF() { /*jshint validthis:true */
    "use strict";

    var sync_schedule = false,
        cycle, scheduling_queue, timer = (typeof setImmediate !== "undefined") ?
        function timer(fn) {
    ...
    function Promise(executor) {
        ...
        try {
            executor.call(
            void 0, function publicResolve(msg) {
                if (def.triggered) {
