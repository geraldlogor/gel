...
function e(t, i, r) {
    ...
    1: [function(e) {
        ...
        gapi.analytics.ready(function() {
            ...
            gapi.analytics.createComponent("ViewSelector2", {
                ...
                template: '<div class="ViewSelector2">  <div class="ViewSelector2-item">    <label>Account</label>    <select></select>  </div>  <div class="ViewSelector2-item">    <label>Property</label>    <select></select>  </div>  <div class="ViewSelector2-item">    <label>View</label>    <select></select>  </div></div>'
            })
        })
    }, {
    ...
    2: [function(e, t) {
        function i(e) {
            ...
            for (var t, i = 0; t = this.accounts_[i]; i++) if (this.accountsById_[t.id] = {
                self: t
            }, t.webProperties) {
                r(t, "webProperties", "properties");
                for (var o, n = 0; o = t.webProperties[n]; n++) if (this.webProperties_.push(o), this.webPropertiesById_[o.id] = {
                    self: o,
                    parent: t
                }, o.profiles) {
                    r(o, "profiles", "views");
